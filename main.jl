...
neg_eigen_list = [1.02, 1.6, 2.92, 2.96]
...
pos_eigen_list = [1.61, 2.11, 2.56, 2.8, 2.95]
...
@time begin
    ...
    for timestep in time_steps
        ...
        # save file
        if timestep == 0
            filename = "images\\9_1_stepfunc\\rational_real\\9_1_0_1000_00005pi_real.png"
        else
            filename = "images\\9_1_stepfunc\\rational_real\\9_1_pi$(pi/timestep)_1000_00005pi_real.png"
        end
        savefig(filename)
    end
end
...
@time begin
    for timestep in time_steps
        ...
        # save file
        if timestep == 0
            filename = "images\\9_1_stepfunc\\rational_img\\9_1_0_1000_00005pi_imaginary.png"
        else
            filename = "images\\9_1_stepfunc\\rational_img\\9_1_pi$(pi/timestep)_1000_00005pi_imaginary.png"
        end
        savefig(filename)
    end
end
...
@time begin
    for timestep in irrational_time_steps
        ...
        # save file
        filename = "images\\9_1_stepfunc\\irrational_real\\9_1_$(timestep)_1000_00005pi_real.png"
        savefig(filename)
    end
end
...
@time begin
    for timestep in irrational_time_steps
        ...
        # save file
        filename = "images\\9_1_stepfunc\\irrational_img\\9_1_$(timestep)_1000_00005pi_imaginary.png"
        savefig(filename)
    end
end