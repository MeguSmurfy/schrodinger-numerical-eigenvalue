...
neg_eigen_list = [1.77, 1.93, 3.18, 3.2]
...
pos_eigen_list = [0.45, 1.67, 2.33, 2.72, 2.93]
...
@time begin
    ...
    for timestep in time_steps
        ...
        # save file
        if timestep == 0
            filename = "images\\9_2_stepfunc\\rational_real\\9_2_0_1000_00005pi_real.png"
        else
            filename = "images\\9_2_stepfunc\\rational_real\\9_2_pi$(pi/timestep)_1000_00005pi_real.png"
        end
        savefig(filename)
    end
end
...
@time begin
    for timestep in time_steps
        ...
        # save file
        if timestep == 0
            filename = "images\\9_2_stepfunc\\rational_img\\9_2_0_1000_00005pi_imaginary.png"
        else
            filename = "images\\9_2_stepfunc\\rational_img\\9_2_pi$(pi/timestep)_1000_00005pi_imaginary.png"
        end
        savefig(filename)
    end
end
...
@time begin
    for timestep in irrational_time_steps
        ...
        # save file
        filename = "images\\9_2_stepfunc\\irrational_real\\9_2_$(timestep)_1000_00005pi_real.png"
        savefig(filename)
    end
end
...
@time begin
    for timestep in irrational_time_steps
        ...
        # save file
        filename = "images\\9_2_stepfunc\\irrational_img\\9_2_$(timestep)_1000_00005pi_imaginary.png"
        savefig(filename)
    end
end