...
neg_eigen_list = [0.5, 1., 2., 2.5, 3.3, 3.5]
...
@time begin
    ...
    for timestep in time_steps
        ...
        # save file
        if timestep == 0
            filename = "images\\9_pi_stepfunc2\\rational_real\\9_pi_0_1000_00005pi_real.png"
        else
            filename = "images\\9_pi_stepfunc2\\rational_real\\9_pi_pi$(pi/timestep)_1000_00005pi_real.png"
        end
        savefig(filename)
    end
end
...
@time begin
    for timestep in time_steps
        ...
        # save file
        if timestep == 0
            filename = "images\\9_pi_stepfunc2\\rational_img\\9_pi_0_1000_00005pi_imaginary.png"
        else
            filename = "images\\9_pi_stepfunc2\\rational_img\\9_pi_pi$(pi/timestep)_1000_00005pi_imaginary.png"
        end
        savefig(filename)
    end
end
...
@time begin
    for timestep in irrational_time_steps
        ...
        # save file
        filename = "images\\9_pi_stepfunc2\\irrational_real\\9_pi_$(timestep)_1000_00005pi_real.png"
        savefig(filename)
    end
end
...
@time begin
    for timestep in irrational_time_steps
        ...
        # save file
        filename = "images\\9_pi_stepfunc2\\irrational_img\\9_pi_$(timestep)_1000_00005pi_imaginary.png"
        savefig(filename)
    end
end